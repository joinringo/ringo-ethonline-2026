    ...
    <main className="mx-auto flex min-h-[70vh] max-w-2xl items-center px-5 py-20 sm:px-6">
      <div className="holo-card w-full rounded-xl">
        <div className="flex items-center gap-2.5 border-b border-hairline px-5 py-3.5">
          ...
          <p className="font-label text-micro font-medium tracking-[0.12em] text-faint uppercase">
            Read failed
          </p>
        </div>
        ...
        <div className="px-5 py-7 sm:px-7">
          ...
          <pre className="mt-6 overflow-x-auto rounded-lg border border-hairline bg-ground/70 px-4 py-3 font-mono text-meta leading-relaxed break-words whitespace-pre-wrap text-danger">
            {error.message}
          </pre>
