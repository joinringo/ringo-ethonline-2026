  ...
  return (
    <span className="group/info relative ml-1.5 inline-flex align-middle">
      <span
        tabIndex={0}
        role="note"
        className="flex h-[15px] w-[15px] cursor-help items-center justify-center rounded-full border border-hairline text-[9px] leading-none font-medium text-faint transition-colors group-hover/info:border-muted group-hover/info:text-muted focus-visible:border-holo focus-visible:text-holo focus-visible:outline-none"
      >
        ?
      </span>
      <span
